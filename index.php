        ...
        <?php if($page == "home" || $page == "about"): ?>
          <div id="header" class="shadow mb-4">
              <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column px-3">
                  <h1 class="w-100 text-center site-title px-5" style="padding-top:80px;"><span style="color: #9be8d3">WELCOME</span> 
                    <br> TO THE
                    <br><span style="color: #9be8d3;"> COFFEE HEAVEN</span></h1>
