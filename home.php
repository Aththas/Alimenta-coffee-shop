  ...
  <section id="services" style="margin-top:100px;" >
    <div class="services container"> <!-- using another class with container class is if we need to overwrite the container class we can overwrite it using the other class-->
      ...
      <div class="service-top">
        ...
        <p>Araliya products will focus on all residents of Sri Lanka. Whether it’s a small business, large business, school, church, or household, there will always be an occasion where purchasing cakes will be required.</p>
      </div>
