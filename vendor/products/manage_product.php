		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/*" <?= !isset($id) ? 'required' : '' ?>>
				</div>
	...
	$(document).ready(function(){
		...
		$('#uni_modal #product-form').submit(function(e){
			...
			$.ajax({
				...
				error:err=>{
					console.error(err)
					el.addClass('alert-success').text("Success");
					_this.prepend(el)
					el.show('.modal')
					end_loader();
				},
